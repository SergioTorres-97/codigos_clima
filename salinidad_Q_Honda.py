...
def ordenar_tributarios(ruta_tributarios_HEC_HMS,Año_simulacion):
    ...
    caudales=caudales.loc[Año_simulacion:Año_simulacion]
...
# secciones=r'C:\Users\sergi\Desktop\Archivos_prueba\SECCIONES_Q_HONDA.xlsx' #Archivo de secciones a entrenar
# ruta_HEC_RAS_nivel=r'C:\Users\sergi\Desktop\Archivos_prueba\salida_nivel_quebrada.xls' #Archivo de niveles (salida HEC-RAS)
# ruta_HEC_RAS_caudal=r'C:\Users\sergi\Desktop\Archivos_prueba\salida_caudal_quebrada.xls' #Archivo de caudal (salida HEC-RAS)
# tributarios_HEC_HMS=r'C:\Users\sergi\Desktop\Archivos_prueba\tributarios_rio_2015.xls' #Tributarios de HEC-HMS (salida HEC-HMS)
# calidad=r'C:\Users\sergi\Desktop\Archivos_prueba\Calidad_quebrada.xlsx' #Se llaman el archivo que contiene la conductividad y la temperatura de los afluentes (Gestión y archivos provenientes de dársenas y lago)
# Estaciones=[25319,22202,4151,4001,3849,150]
# junction=['J751','DELFINES','LA PLAYA','Q. CANOCAS']
#

ruta_archivos=r'C:\Users\sergi\Desktop\Archivos_prueba\Escenario_base\2002'
secciones=ruta_archivos+'\\'+'SECCIONES_Q_HONDA.xlsx' #Archivo de secciones a entrenar
ruta_HEC_RAS_nivel=ruta_archivos+'\\'+'2002_niveles.xls' #Archivo de niveles (salida HEC-RAS)
ruta_HEC_RAS_caudal=ruta_archivos+'\\'+'2002_caudales.xls' #Archivo de caudal (salida HEC-RAS)
tributarios_HEC_HMS=ruta_archivos+'\\'+'Informacion_escenario_base.xls' #Tributarios de HEC-HMS (salida HEC-HMS)
calidad=ruta_archivos+'\\'+'Calidad_quebrada.xlsx' #Se llaman el archivo que contiene la conductividad y la temperatura de los afluentes (Gestión y archivos provenientes de dársenas y lago)
Estaciones=[25319,22202,4151,4001,3849,150]
junction=['J751','DELFINES','PLAYA','Q. CANOCAS']
año_simulacion='1999'
...
par1,par2,min=calculo_de_areas(secciones,Estaciones) #Se calculan los parametros de las ecuaciones para el calculo de las áreas
print(min)
...
caudal_trib=ordenar_tributarios(tributarios_HEC_HMS,año_simulacion)[0] #Se ordenan los tributarios
print(caudal_trib)
fecha=ordenar_tributarios(tributarios_HEC_HMS,año_simulacion)[1]
#Se aplica la funcion caudal_tributario a cada sección, teniendo en cuenta los afluentes respectivos (Ej: lago)
est_22720=[0 for i in range(0,len(caudal_trib))] #La primera sección no recibe afluentes
est_19603=[0 for i in range(0,len(caudal_trib))]
est_4150=caudal_tributario(caudal_trib,[junction[2]])
est_4000=caudal_tributario(caudal_trib,[junction[1]])
est_3848=caudal_tributario(caudal_trib,[junction[3]])
est_150=[0 for i in range(0,len(caudal_trib))] #La primera sección no recibe afluentes

#Se concatenan las listas en una sola
tributarios=[est_22720,est_19603,est_4150,est_4000,est_3848,est_150]
...
convertir_dataframe(conc,fecha,Estaciones).to_excel(ruta_archivos+'\\'+'Salinidad_Quebrada_Honda.xlsx')
